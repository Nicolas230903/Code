...
jQuery(document).ready(function () {
    ...
    var compra = ObtenerIvaCompras();
    var venta = ObtenerIvaVentas();

    var data = [
        { label: "Compra", data: compra, color: "#D9534F" },
        { label: "Venta", data: venta, color: "#1CAF9A" }
    ];
...
function ObtenerIvaCompras() {
    var ddata = [];

    $.ajax({
        type: "GET",
        url: "/modulos/reportes/iva-saldo.aspx/obtenerIvaCompras",
...
function ObtenerIvaVentas() {
    var ddata = [];

    $.ajax({
        type: "GET",
        url: "/modulos/reportes/iva-saldo.aspx/obtenerIvaVentas",
        async: false,//wait for result
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg, text) {
...
function verDetalle(tipoDeEgresoIngreso, index) {
    ...
    $.ajax({
        type: "POST",
        url: "/modulos/reportes/iva-saldo.aspx/getDetail",
        data: info,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function exportarDetalle() {
    ...
    $.ajax({
        type: "POST",
        url: "/modulos/reportes/iva-saldo.aspx/exportDetalle",
        data: info,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
