...
jQuery(document).ready(function () {
    ...
    var data = [
        { label: "Compras", data: compras, color: "#D9534F" },
        { label: "Ventas", data: ventas, color: "#1CAF9A" }
    ];
...
function ObtenerVentas() {
    ...
    $.ajax({
        type: "POST",
        url: "ventas-vs-compras.aspx/obtenerVentas",
        //data: info,
...
function ObtenerCompras() {
    ...
    $.ajax({
        type: "POST",
        url: "ventas-vs-compras.aspx/obtenerCompras",
        //data: info,
        async: false,//wait for result
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function verDetalle (tipoDeEgresoIngreso,index) {        
    ...
    $.ajax({
        type: "POST",
        url: "ventas-vs-compras.aspx/getDetail",
        data: info,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function exportarDetalle() {
    ...
    $.ajax({
        type: "POST",
        url: "ventas-vs-compras.aspx/exportDetalle",
        data: info,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
