...
function configFilters() {
    ...
    Common.obtenerPuntosDeVenta("ddlPuntoVenta", "", true);
    Common.obtenerActividades("ddlActividad", "", true);
...
function filtrar() {
    ...
    if ($('#frmSearch').valid()) {
        ...
        var idPuntoVenta = 0;
        if ($("#ddlPuntoVenta").val() != "" && $("#ddlPuntoVenta").val() != null)
            idPuntoVenta = parseInt($("#ddlPuntoVenta").val());

        var idActividad = 0;
        if ($("#ddlActividad").val() != "" && $("#ddlActividad").val() != null)
            idActividad = parseInt($("#ddlActividad").val());
        ...
        $.ajax({
            type: "POST",
            url: "iva-ventas.aspx/getResults",
            data: info,
...
function verTodos() {
    $("#txtFechaDesde, #txtFechaHasta, #ddlPuntoVenta, #ddlActividad, #ddlCondicionIVA").val("");
