        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <a class="btn btn-black" onclick="cobranzasPendientes.resetearPagina();cobranzasPendientes.filtrar();">Buscar</a>
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <div class="btn btn-white tooltips">
                                    ...
                                    <a href="" id="lnkDownload" onclick="cobranzasPendientes.resetearExportacion();" download="CuentaCorriente" style="display: none">Descargar</a>
                                </div>
                            </div>
