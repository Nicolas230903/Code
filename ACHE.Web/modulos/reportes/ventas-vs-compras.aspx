<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="ventas-vs-compras.aspx.cs" Inherits="modulos_reportes_ventas_vs_compras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Ventas vs Compras</h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Estás aquí:</span>
            <ol class="breadcrumb">
                <li><a href="/home.aspx">axanweb</a></li>
                <li><a href="#">Reportes</a></li>
                <li class="active">Ventas vs Compras</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">¿Qué información estoy viendo en este gráfico? Las ventas y compras efectuadas en los últimos 12 meses. No se incluyen las cotizaciones</h4>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="Server">
    ...
    <script src="/js/views/reportes/ventas-vs-compras.js?v=<%= ConfigurationManager.AppSettings["JS.Version"] %>"></script>
