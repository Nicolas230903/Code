...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Detalle bancario </h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Estás aquí:</span>
            <ol class="breadcrumb">
                <li><a href="/home.aspx">axanweb</a></li>
                <li>Reportes</li>
                <li class="active">Detalle bancario</li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <div class="mb20"></div>
                    <h4 class="subtitle mb5">Bancos</h4>
                    ...
                    <a class="btn btn-black" onclick="DetalleBancario.resetearPagina();DetalleBancario.filtrar();">Buscar</a>
