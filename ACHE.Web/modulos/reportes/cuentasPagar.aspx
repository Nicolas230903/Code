<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="cuentasPagar.aspx.cs" Inherits="modulos_reportes_cuentasPagar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Cuentas a Pagar </h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Estás aquí:</span>
            <ol class="breadcrumb">
                <li><a href="/home.aspx">axanweb</a></li>
                <li><a href="#">Reportes</a></li>
                <li class="active">Cuentas a Pagar</li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <div class="mb20"></div>
                    <h4 class="subtitle mb5">Vencimientos</h4>
                    <select class="select2" data-placeholder="Seleccione un vencimiento" id="ddlVencimiento">
                        <option value=""></option>
                        <option value="Vencidas">Vencidas</option>
                        <option value="Vencidas al 1° vencimiento">Vencidas al 1° vencimiento</option>
                        <option value="Vencidas al 2° vencimiento">Vencidas al 2° vencimiento</option>
                        <option value="Proximas a vencer">Proximas a vencer</option>
                        <option value="Proximas a vencer al 1° vencimiento">Proximas a vencer al 1° vencimiento</option>
                        <option value="Proximas a vencer al 2° vencimiento">Proximas a vencer al 2° vencimiento</option>
                    </select>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="Server">
    ...
    <script src="/js/views/reportes/cuentasPagar.js?v=<%= ConfigurationManager.AppSettings["JS.Version"] %>"></script>
