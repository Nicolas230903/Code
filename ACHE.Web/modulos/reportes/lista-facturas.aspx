<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="lista-facturas.aspx.cs" Inherits="lista_facturas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Lista masiva de facturas</h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Estás aquí:</span>
            <ol class="breadcrumb">
                <li><a href="/home.aspx">axanweb</a></li>
                <li><a href="#">Reportes</a></li>
                <li class="active">Lista masiva de facturas</li>
            </ol>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" Runat="Server">
    ...
    <script src="/js/views/reportes/lista-facturas.js?v=<%= ConfigurationManager.AppSettings["JS.Version"] %>"></script>
