<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="rnk-clientes.aspx.cs" Inherits="modulos_reportes_rnk_clientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Ranking de clientes</h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Estás aquí:</span>
            <ol class="breadcrumb">
                <li><a href="/home.aspx">axanweb</a></li>
                <li><a href="#">Reportes</a></li>
                <li class="active">Ranking de clientes</li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <div class="mb20"></div>
                    <h4 class="subtitle mb5">Provincia</h4>
                    <asp:DropDownList runat="server" ID="ddlProvincia" CssClass="select2" data-placeholder="Selecciona una provincia..." onchange="changeProvincia();">
                    </asp:DropDownList>

                    <div class="mb20"></div>
                    <h4 class="subtitle mb5">Ciudad/Localidad</h4>
                    <asp:DropDownList runat="server" ID="ddlCiudad" CssClass="select2" data-placeholder="Selecciona una ciudad...">
                    </asp:DropDownList>
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <div class="btn btn-white tooltips">
                                    ...
                                    <a href="" id="lnkDownload" onclick="resetearExportacion();" download="RankingClientes" style="display: none">Descargar</a>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="Server">
    ...
    <script src="/js/views/reportes/rnk-clientes.js?v=<%= ConfigurationManager.AppSettings["JS.Version"] %>"></script>
