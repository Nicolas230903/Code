        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <a class="btn btn-black" onclick="EstadoResultado.resetearPagina();EstadoResultado.filtrar();">Buscar</a>
                    <a class="btn btn-default" onclick="EstadoResultado.resetearPagina();EstadoResultado.verTodos();">Ver todos</a>
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <div class="btn btn-white tooltips">
                                    ...
                                    <a href="" id="lnkDownload" onclick="EstadoResultado.resetearExportacion();" download="IvaVentas" style="display: none">Descargar</a>
                                </div>
                            </div>
