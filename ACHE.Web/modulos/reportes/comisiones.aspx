<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" CodeFile="comisiones.aspx.cs" Inherits="modulos_reportes_comisiones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageheader">
        <h2><i class="fa fa-bar-chart-o"></i>Comisiones </h2>
        ...
        <div class="row">
            <div class="col-sm-4 col-md-3">
                <form runat="server" id="frmSearch">
                    ...
                    <div class="mb20"></div>
                    <h4 class="subtitle mb5">Vendedor</h4>
                    <select class="select2" data-placeholder="Seleccione un vendedor..." id="ddlVendedor">
                        <option value=""></option>
                    </select>

                    <div class="mb20"></div>

                    <label><input type="checkbox" id="chkTotales"/><span>&nbsp;Totales</span></label>
                        ...
                        <div class="pull-right">
                            <div class="btn-group mr10">
                                <div class="btn btn-white tooltips">
                                    ...
                                    <a href="" id="lnkDownload" onclick="resetearExportacion();" download="Comisiones" style="display: none">Descargar</a>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="Server">
    ...
    <script src="/js/views/reportes/comisiones.js?v=<%= ConfigurationManager.AppSettings["JS.Version"] %>"></script>
