...
public partial class modulos_reportes_ventas_vs_compras : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        using (var dbContext = new ACHEEntities())
        {
            ...
            if (afu != null)
                if (!afu.InfoFinancierosVentasVsCompras)
    ...
    public static List<Chart> obtenerVentas()
    {
        ...
        if (HttpContext.Current.Session["CurrentUser"] != null)
        {
            ...
            using (var dbContext = new ACHEEntities())
            {
                ...
                var mes12 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes11 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes10 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes9 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes8 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes7 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes6 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes5 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes4 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes3 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes2 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                ...
                var mes1 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Ventas '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
    ...
    [WebMethod(true)]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<Chart> obtenerCompras()
    {
        string formato = ConfigurationManager.AppSettings["FormatoFechasSQL"];
        List<Chart> list = new List<Chart>();
        if (HttpContext.Current.Session["CurrentUser"] != null)
        {
            ...
            using (var dbContext = new ACHEEntities())
            {
                fechaDesde = DateTime.Now.AddMonths(-11).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-11).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes12 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "1", data = (mes12.Any() ? mes12[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-10).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-10).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes11 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "2", data = (mes11.Any() ? mes11[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-9).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-9).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes10 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "3", data = (mes10.Any() ? mes10[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-8).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-8).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes9 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "4", data = (mes9.Any() ? mes9[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-7).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-7).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes8 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "5", data = (mes8.Any() ? mes8[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-6).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-6).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes7 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "6", data = (mes7.Any() ? mes7[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-5).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-5).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes6 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "7", data = (mes6.Any() ? mes6[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-4).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-4).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes5 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "8", data = (mes5.Any() ? mes5[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-3).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-3).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes4 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "9", data = (mes4.Any() ? mes4[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-2).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-2).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes3 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "10", data = (mes3.Any() ? mes3[0].data : 0) });

                fechaDesde = DateTime.Now.AddMonths(-1).GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.AddMonths(-1).GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes2 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "11", data = (mes2.Any() ? mes2[0].data : 0) });

                fechaDesde = DateTime.Now.GetFirstDayOfMonth().ToString(formato);
                fechaHasta = DateTime.Now.GetLastDayOfMonth().ToString(formato + " 12:59:59");
                var mes1 = dbContext.Database.SqlQuery<Chart>("exec Dashboard_Compras '" + fechaDesde + "','" + fechaHasta + "', " + usu.IDUsuario, new object[] { }).ToList();
                list.Add(new Chart() { label = "12", data = (mes1.Any() ? mes1[0].data : 0) });
            }
        }
            ...
            if (Etiqueta == "Ventas")
            {
                ...
                foreach (var item in listIng)
                {
                    ...
                    if (det.TipoComprobante == "NCA" || det.TipoComprobante == "NCB" || det.TipoComprobante == "NCC")
                        det.Total = Convert.ToInt32(-item.ImporteTotalBruto).ToString("N2");
                    else
                    {
                        if (item.Tipo.Equals("PDV"))
                        {
                            decimal totalSumaFacDesdePDV = 0;
                            totalSumaFacDesdePDV = dbContext.Comprobantes.Where(x => x.IdComprobanteVinculado == item.IDComprobante).Sum(x => x.ImporteTotalBruto);
                            det.Total = Convert.ToInt32(item.ImporteTotalBruto - totalSumaFacDesdePDV).ToString("N2");
                        }
                        else
                        {
                            if (item.Tipo.Contains("F") && item.IdComprobanteVinculado == null)
                                det.Total = Convert.ToInt32(item.ImporteTotalBruto).ToString("N2");                            
                        }                        
                    }
