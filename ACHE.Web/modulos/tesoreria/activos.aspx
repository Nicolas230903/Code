<%@ page title="" language="C#" masterpagefile="~/Front.master" autoeventwireup="true" CodeFile="activos.aspx.cs" inherits="modulos_tesoreria_activos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="pageheader">
        <h2>
            <i class='fa fa-archive'></i>Activos <span>Administración</span>
        </h2>
    ...
    <div id="divConDatos" runat="server">
            ...
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    <form runat="server" id="frmSearch">
                        <a class="btn btn-warning btn-block" onclick="activos.nuevo();">
                        ...
                        <h4 class="subtitle mb5">Fecha de Compra</h4>
                        ...
                        <a class="btn btn-black" onclick="activos.resetearPagina();activos.filtrar();">Buscar</a>
                        <a class="btn btn-default" onclick="activos.resetearPagina();activos.verTodos();">Ver todos</a>
                        <br />
                    </form>
                </div>
                            ...
                            <div class="pull-right">
                                <div class="btn-group mr10">
                                    <div class="btn btn-white tooltips">
                                        <a id="divIconoDescargar" href="javascript:activos.exportar();">
                                            <i class="glyphicon glyphicon-save"></i>&nbsp;Exportar
                                        </a>
                                        <img alt="" src="/images/loaders/loader1.gif" id="imgLoading" style="display: none" />
                                        <a href="" id="lnkDownload" onclick="activos.resetearExportacion();" download="ClientesProv" style="display: none">Descargar</a>
                                    </div>
                                </div>

                                <div class="btn-group mr10" id="divPagination" style="display: none">
                                    <a class="btn btn-white" id="lnkPrevPage" style="cursor: pointer" onclick="activos.mostrarPagAnterior();"><i class="glyphicon glyphicon-chevron-left"></i>Anterior</a>
                                    <a class="btn btn-white" id="lnkNextPage" style="cursor: pointer" onclick="activos.mostrarPagProxima();">Siguiente <i class="glyphicon glyphicon-chevron-right"></i></a>
                                </div>
                            </div>
        ...
        <tr>
            ...
            <td class="table-action">
                <a onclick="activos.editar(${ID});" style="cursor: pointer; font-size: 16px" title="Editar"><i class="fa fa-pencil"></i></a>
                <a onclick="activos.eliminar(${ID},'${NumeroDeSerie}');" style="cursor: pointer; font-size: 16px" class="delete-row" title="Eliminar"><i class="fa fa-trash-o"></i></a>
            </td>
        </tr>
            {{/each}}
        </script>
    ...
    <div id="divSinDatos" runat="server">
        <div class="panel-heading" style="background-color: white; height: 30%; width: 100%; border-radius: 4px; text-align: center;">
            <h4 id="hTitulo">Aún no has creado ningún activo</h4>
            <br>
            <a class="btn btn-warning" onclick="activos.nuevo();" id="btnNuevoSinDatos">Crea un activo</a>
        </div>
    </div>
</asp:Content>
